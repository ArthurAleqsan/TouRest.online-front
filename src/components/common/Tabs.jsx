    ...
    return (
        <div className="tabs">
            <div className="tabs-container">
                {width <= 800 && (
                    <div
                        className="responsive-tab-container"
                        style={{ height: "100" }}
                    >
                        <div
                            className="tab-icon"
                        ...
                        >
                            {activeHeader !== "Vip Tours" && (
                                <IconComponent icon={`${activeIcon}`} />
                            )}
                        </div>
                        <div className="tab-name">
                            <span className="tabs-name">
                                {activeHeader == "Most Popular"
                                    ? t("Most Popular")
                                    : activeHeader}{" "}
                            </span>
                        </div>
