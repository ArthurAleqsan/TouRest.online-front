        ...
        <header className='header'>
            <div className='header-logo-container'>
                <Link to='/' onClick={handleResetImages}>
                    <img className='logo' src={'/assets/images/logo.png'} alt='TouRest.online' />
                </Link>
            </div>
            <div className='header-rigth-container' >
                ...
                >
                    ...
                    <div className='header-content-tab' style={{ display: width > 1280 ? 'flex' : 'none' }}>
                        <Link className='link' to={`/${location}/${lng}/blog`}>{t('Blog')}</Link>
                        <div className='header-content-border-bottom'></div>
                    </div>
                    <div className='header-content-tab' style={{ display: width > 1280 ? 'flex' : 'none' }}>
                        <Link className='link' to={`/${location}/${lng}/cart`}>{t('Cart')}</Link>
                        <div className='header-content-border-bottom'></div>
                    </div>
                    ...
                    <div
                        ...
                        style={{ display: width > 1280 ? 'flex' : 'none' }}
                    >
                        <div className={`lng-container  ${lng === 'Eng' ? 'lng-eng' : 'lng-arm'}`}
                            style={{ display: width > 1280 ? 'flex' : 'none' }}
                        >
            ...
            <div className='header-menu-container link' onClick={() => toogleList()}>
                <a className='header-menu-icon' >
                    <div className='header-icon' style={{ width: 30, height: 30, color: '#000' }}>
