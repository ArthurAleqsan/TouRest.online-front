...
export const CityPopup = memo(withRouter(({ visible, setVisible, cities, setCity, resetCategories, setOrderData }) => {
        ...
        <div className='modal-container'>
            ...
            >
                <div className='modal-header-container'>
                    <p className='modal-header'>{t('Welcome to TouRest.online')}</p>
                    <p className='modal-header-text'>{t('Please choose the location')}</p>
